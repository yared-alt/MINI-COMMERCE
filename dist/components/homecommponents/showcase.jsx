...
function showcase({ maxw }) {
    return (<div className='bg-gradient-to-l from-zinc-800  via-zinc-400 via-70% to-slate-300:'>
            <div className={`${maxw} show_case bg-gradient-to-l py-7 pb-24 px-5 md:flex md:justify-end`}>
