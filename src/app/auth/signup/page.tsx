                ...
                <div className=" login-card md:rounded-t-lg md:py-10 md:mx-5 md:bg-transparent backdrop-blur-2xl  ">
                    ...
                    <div className='px-2'>
                        <div className='my-5'>
                            <input
                                type='email'
                                className='px-3 w-[100%] py-2 rounded-md backdrop-blur-2xl  placeholder-red-black focus:duration-700'
                                placeholder='name'
                                value={name}
                                onChange={(e) => {
                        ...
                        <div className='my-5'>
                            <input
                                type='email'
                                className='px-3 w-[100%] placeholder-red-black py-2 rounded-md backdrop-blur-2xl  focus:duration-700'
                        ...
                        <div>
                            <input
                                type='password'
                                className='px-3 w-[100%] placeholder-red-black py-2 rounded-md backdrop-blur-2xl
                                focus:duration-700' placeholder='password'
                                value={password}
                                onChange={(e) => {
                        ...
                        <div className='flex flex-col mt-6'>
                            <input
                                ...
                                type='submit'
                                disabled={loading}
                                value={loading ? "lodding..." : "signup"}
                                className={`capitalize px-9 py-3 md:px-3  rounded-lg bg-green-400 hover:text-white      ${loading ? " cursor-wait" : "cursor-pointer"} `}
                            />
