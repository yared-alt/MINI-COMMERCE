...
dotenv.config();
// Read the JSON file
var dataPath = path.join(__dirname, "migraterdata.json");
var data = JSON.parse(fs.readFileSync(dataPath, "utf-8"));
// Debug the MongoDB URI
console.log("MongoDB URI:", process.env.MONGODB_URI);
function migrate() {
    return __awaiter(this, void 0, void 0, function () {
        var uri, client, database, collection, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    collection = database.collection("allproducts");
                    return [4 /*yield*/, collection.insertMany(data)];
                case 3:
                    result = _a.sent();
                    console.log(result);
                    console.log("".concat(result.insertedCount, " documents were inserted"));
                    return [3 /*break*/, 7];
                case 4:
                    error_1 = _a.sent();
